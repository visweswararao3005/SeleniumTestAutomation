...
namespace TestAutomation.Tests
{
    [TestFixture]
    [Category("Capital")]
    public class Capital_TestCases : BaseTest
    {
        ...
        private static readonly Dictionary<string, string> L = JsonConvert.DeserializeObject<Dictionary<string, string>>(File.ReadAllText(Path.Combine(projectRoot, Config.Get("AppSettings:CapitalDataPointsFile"))));
        ...
        private static readonly string LoginTestCaseFile = File.ReadAllText(Path.Combine(projectRoot, $"TestData\\Capital\\LoginTestData.json"));
        private readonly string ItemsFile = File.ReadAllText(Path.Combine(projectRoot, $"TestData\\Capital\\Items.json"));
        private readonly string CustomersFile = File.ReadAllText(Path.Combine(projectRoot, $"TestData\\Capital\\Customers.json"));
        private readonly string CustomersItemMappingFile = File.ReadAllText(Path.Combine(projectRoot, $"TestData\\Capital\\CustomerItemMapping.json"));
        private readonly string OrderFile = File.ReadAllText(Path.Combine(projectRoot, $"TestData\\Capital\\Orders.json"));
        ...
        [Test, TestCaseSource(nameof(Cases)), Order(1), Category("Capital"), Category("Run_Login_Scenarios")]
        ...
        [Test, Order(2), Category("Capital"), Category(" ")]
        public void Add_Customers_Test()
        {
            ...
            try
            {
                ...
                errorMsg = Captial_AddCustomer(L);
        ...
        [Test, Order(3), Category("Capital"), Category("Add_Items_Test")]
        ...
        [Test, Order(4), Category("Capital"), Category(" ")]
        public void Customer_Item_Mapping_Test()
        {
            ...
            try
            {
                ...
                // Step 3: Add Customers
                errorMsg = Capital_CustomerItemMapping(L);
        ...
        [Test, Order(5), Category("Capital"), Category("Order_Creation_Test")]
        public void Order_Creation_Test()
        {
            ...
            try
            {
                ...
                errorMsg = Capital_CreateOrder(L);
                if (!string.IsNullOrEmpty(errorMsg))
                {
                    status = "Fail";
        ...
        IWebDriver _driver;
        public string Capital_explore(Dictionary<string, string> L)
        {
            _driver = Driver;
        ...
        public string Captial_AddCustomer(Dictionary<string, string> L)
        {
            _driver = Driver;
            string error = string.Empty;
        ...
        public string Capital_AddItem(Dictionary<string, string> L)
        {
            _driver = Driver;
            var page = new CommonTestCasesHelper(Driver);
            string error = string.Empty;
        ...
        public string Capital_CustomerItemMapping(Dictionary<string, string> L)
        {
            _driver = Driver;
            string error = string.Empty;
        ...
        public string Capital_CreateOrder(Dictionary<string, string> L)
        {
            _driver = Driver;
            string error = string.Empty;
            int time = 3000;
                        ...
                        if (badgeClass.Contains("badge-warning"))
                        {
                            ...
                            switch (stepNumber)
                            {
                                case "1":
                                    ...
                                    error = Capital_addOrderDetails(order ,L);
                                    if (!string.IsNullOrEmpty(error))
                                    {
        ...
        public string Capital_addOrderDetails(Order order, Dictionary<string, string> L)
        {
            _driver = Driver;
            string error = string.Empty;
